...
|---|---|---:|---|
| compiler flotation | pass | 66.566 | `cargo run --quiet --bin sdplc -- programs/flotation_tank.st -o results/flotation_tank -q` |
| compiler control_flow | pass | 0.717 | `cargo run --quiet --bin sdplc -- programs/control_flow.st -o results/control_flow -q` |
| flotation runtime 10ms | pass | 14.050 | `cargo run --quiet --bin runtime -- programs/flotation_tank.st --cycles=1000 --scan-time=10 --out=results/.scan-timing-10ms -q` |
| flotation runtime 20ms | pass | 20.444 | `cargo run --quiet --bin runtime -- programs/flotation_tank.st --cycles=1000 --scan-time=20 --out=results/.scan-timing-20ms -q` |
| flotation runtime 50ms | pass | 50.444 | `cargo run --quiet --bin runtime -- programs/flotation_tank.st --cycles=1000 --scan-time=50 --out=results/.scan-timing-50ms -q` |
| control_flow runtime 10ms | pass | 10.437 | `cargo run --quiet --bin runtime -- programs/control_flow.st --cycles=1000 --scan-time=10 --out=results/.control-flow-scan-timing-10ms -q` |
| opcua read/write latency | pass | 31.290 | `cargo run --quiet --bin opcua_server -- programs/flotation_tank.st --scan-time=10 --self-test --read-count=1000 --write-count=100 --out=results` |
